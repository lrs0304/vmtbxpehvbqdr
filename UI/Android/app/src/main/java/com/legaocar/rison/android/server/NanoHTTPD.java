...
public class NanoHTTPD {
    ...
    private final static String TAG = "NanoHTTPD";
    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files) {
        String info = method + " '" + uri + "' ";

        Enumeration e = header.propertyNames();
        while (e.hasMoreElements()) {
            String value = (String) e.nextElement();
            info += "\n  header: '" + value + "' = '" + header.getProperty(value) + "'";
        }
        e = parms.propertyNames();
        while (e.hasMoreElements()) {
            String value = (String) e.nextElement();
            info += "\n  params: '" + value + "' = '" + parms.getProperty(value) + "'";
        }
    ...
    private class HTTPSession implements Runnable {
        ...
        public void run() {
            try {
                ...
                if (r == null)
                    sendError(HTTP_INTERNALERROR, "SERVER INTERNAL ERROR: Null response.");
                else
